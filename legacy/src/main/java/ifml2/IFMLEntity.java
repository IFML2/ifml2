...
public class IFMLEntity implements Cloneable {
    protected static <T extends IFMLEntity> EventList<T> deepCloneEventList(@NotNull EventList<T> eventList,
            @NotNull Class<T> clazz) throws CloneNotSupportedException {
        ...
        for (T element : eventList) {
            ...
            if (clazz.isInstance(clone)) {
                ...
                throw new IllegalArgumentException(
                        MessageFormat.format("EventList doesn't hold objects of {0} class", clazz.getSimpleName()));
            }
        }
        return cloneList;
    }
