...
public class GUIUtils {
    ...
    public static boolean showDeleteConfirmDialog(Component owner, String objectNameVP, String objectNameRP,
        ...
        return JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(owner, question, title,
                JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    }

    /**
     * Make AbstractAction dependent from JList selection: enable then something is
