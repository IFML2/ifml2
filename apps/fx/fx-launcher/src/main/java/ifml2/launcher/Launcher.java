...
public class Launcher {
    ...
    /**
     * @param args if first arg is 'player' or 'editor' then appropriate program will
     *             be launched, else player is launched with first parameter
     */
    public static void main(String[] args) {
        ...
        if (args.length > 0 && "player".equalsIgnoreCase(args[0])) {
            ...
            Object answer = JOptionPane.showInputDialog(null, "Что запустить?",
                    format("%s %s", RUSSIAN_PRODUCT_NAME, EngineVersion.VERSION), JOptionPane.QUESTION_MESSAGE, null,
                    new Object[]{playerOption, editorOption, testerOption}, playerOption);
