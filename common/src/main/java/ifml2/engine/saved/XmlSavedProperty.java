...
public class XmlSavedProperty implements SavedProperty {
    private static final Logger LOG = LoggerFactory.getLogger(XmlSavedProperty.class);
    ...
    public XmlSavedProperty() {
        // JAXB
    }

    public XmlSavedProperty(Property property) {
    ...
    public void restore(Role role, Story.DataHelper dataHelper) {
