...
public class XmlSavedLocation implements SavedLocation {

    @XmlTransient
    private static final Logger LOG = LoggerFactory.getLogger(XmlSavedLocation.class);
    ...
    public XmlSavedLocation() {
        // for JAXB
    }

    public XmlSavedLocation(Location location) {
        id = location.getId();
