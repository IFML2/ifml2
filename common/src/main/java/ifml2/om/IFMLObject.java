...
public class IFMLObject extends IFMLEntity {
    ...
    public IFMLObject clone() throws CloneNotSupportedException {
        ...
        // clone deeper
        clone.hooks = IFMLEntity.deepCloneEventList(hooks, Hook.class);
        clone.roles = IFMLEntity.deepCloneEventList(roles, Role.class);
        clone.properties = IFMLEntity.deepCloneEventList(properties, Property.class);
    ...
    public void copyTo(IFMLObject ifmlObject) throws CloneNotSupportedException {
        ...
        ifmlObject.setProperties(IFMLEntity.deepCloneEventList(properties, Property.class));
        ifmlObject.setHooks(IFMLEntity.deepCloneEventList(hooks, Hook.class));
        ifmlObject.setRoles(IFMLEntity.deepCloneEventList(roles, Role.class));
    }
