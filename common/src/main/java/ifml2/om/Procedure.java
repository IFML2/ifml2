...
public class Procedure extends IFMLEntity implements Cloneable {
    ...
    public Procedure clone() throws CloneNotSupportedException {
        ...
        // clone deeper
        clone.variables = IFMLEntity.deepCloneEventList(variables, ProcedureVariable.class);
        clone.procedureBody = procedureBody.clone();
        clone.parameters = IFMLEntity.deepCloneEventList(parameters, Parameter.class);
    ...
    public void copyTo(Procedure procedure) throws CloneNotSupportedException {
        ...
        procedure.variables = IFMLEntity.deepCloneEventList(variables, ProcedureVariable.class);
        procedure.procedureBody = procedureBody.clone();
        procedure.parameters = IFMLEntity.deepCloneEventList(parameters, Parameter.class);
    }
