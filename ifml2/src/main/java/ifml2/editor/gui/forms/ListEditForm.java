...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        upButton.setIcon(new ImageIcon(getClass().getResource("/ifml2/editor/gui/images/Up24.gif")));
        upButton.setText("");
        toolBar1.add(upButton);
        downButton = new JButton();
        downButton.setIcon(new ImageIcon(getClass().getResource("/ifml2/editor/gui/images/Down24.gif")));
        downButton.setText("");
        ...
        addElementButton.setIcon(new ImageIcon(getClass().getResource("/ifml2/editor/gui/images/Add24.gif")));
        ...
        editElementButton.setIcon(new ImageIcon(getClass().getResource("/ifml2/editor/gui/images/Edit24.gif")));
        ...
        delElementButton.setIcon(new ImageIcon(getClass().getResource("/ifml2/editor/gui/images/Delete24.gif")));
