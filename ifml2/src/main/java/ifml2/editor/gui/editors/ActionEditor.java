...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        upRestrictionButton.setText("Button");
        toolBar3.add(upRestrictionButton);
        downRestrictionButton = new JButton();
        downRestrictionButton.setText("Button");
