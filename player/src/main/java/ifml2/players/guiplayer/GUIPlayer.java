...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        commandText.setCaretColor(Color.green);
        Font commandTextFont = this.$$$getFont$$$("Segoe UI", -1, 16, commandText.getFont());
        if (commandTextFont != null) commandText.setFont(commandTextFont);
        commandText.setForeground(Color.green);
        commandText.putClientProperty("caretWidth", new Integer(3));
        commandText.putClientProperty("html.disable", Boolean.FALSE);
        mainPanel.add(commandText, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        Font logTextPaneFont = this.$$$getFont$$$("Segoe UI", -1, 16, logTextPane.getFont());
        if (logTextPaneFont != null) logTextPane.setFont(logTextPaneFont);
        logTextPane.setForeground(Color.green);
        logTextPane.setMargin(new Insets(4, 4, 4, 4));
