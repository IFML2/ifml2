...
public enum InstructionTypeEnum
{
    ...
    SET_VAR (SetVarInstruction.class),
    MOVE_ITEM (MoveItemInstruction.class);
    ...
    public static InstructionTypeEnum getItemByClass(@NotNull Class<? extends Instruction> instructionClass) throws Exception
    {
        ...
        throw new Exception(MessageFormat.format("No enum element associated with class {0}", instructionClass));
    }
}
