...
public class DictionaryEditor extends JDialog {
    ...
    public DictionaryEditor(Frame owner) {
        ...
        dictList.addListSelectionListener(e -> repaintCurrentWord((Word) dictList.getSelectedValue()));
        ...
        newWordButton.setAction(new ButtonAction(newWordButton) {
            @Override
        ...
        delWordButton.setAction(new ButtonAction(delWordButton) {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    private void setAllData(HashMap<String, Word> dictionary) {
